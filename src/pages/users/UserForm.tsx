...
export default function UserForm({ onSubmit }: { onSubmit: (user: User) => void }) {
    ...
    const [categories_, setCategorie_] = React.useState([]);
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (phoneNumber.length !== 13 || phoneNumber.startsWith('+998') === false) {
                            ...
                            role === 'EMP' && (
                                <Grid item xs={12}>
                                    <Select
                                        ...
                                        onChange={(e: any) => setCategorie_(e.map((item: any) => item.value))}
                                    />
                                </Grid>
                            )
                        }
